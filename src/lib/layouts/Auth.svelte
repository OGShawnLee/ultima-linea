...
<div class="min-h-screen px-2 sm:px-0 py-12 md:grid place-content-center gap-0.5">
	...
	<div class="md:w-xl flex flex-col bg-ground-1-light dark:bg-ground-1 rounded-xl border border-ground-3-light dark:border-ground-3">
		...
		<div class="self-stretch p-8 flex-col justify-center items-center gap-6 flex">
			<slot {Input} />
			...
			<a
				class="border-focus-effect h-10 px-4 flex items-center justify-center rounded-full"
