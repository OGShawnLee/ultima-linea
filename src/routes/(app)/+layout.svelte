<script>
	...
	import { LogIn, Moon, Search, Sun } from "lucide-svelte";
	import { mode, toggleMode } from "mode-watcher";
</script>

<header class="fixed top-0 inset-0 h-20 bg-ground-0-light/75 dark:bg-ground-0/75 backdrop-filter backdrop-blur-lg">
